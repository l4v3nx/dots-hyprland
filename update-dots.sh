...
excludes=(".config/fish/fish_variables" ".config/mpv/mpv.conf" ".config/qt5ct/qt5ct.conf" ".config/qt6ct/qt6ct.conf" ".config/hypr/hyprland/colors.conf" ".config/fuzzel/fuzzel.ini" ".config/ags/scss/_material.scss" ".config/Kvantum/MaterialAdw/MaterialAdw.kvconfig" ".config/Kvantum/MaterialAdw/MaterialAdw.svg")
