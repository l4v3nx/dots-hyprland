...
excludes=(".config/ags/user_options.jsonc" ".config/fish/fish_variables" ".config/mpv/mpv.conf" ".config/qt5ct/qt5ct.conf" ".config/qt6ct/qt6ct.conf" ".config/hypr/hyprland/colors.conf" ".config/hypr/custom/general.conf" ".config/fuzzel/fuzzel.ini" ".config/ags/scss/_material.scss" ".config/Kvantum/MaterialAdw/MaterialAdw.kvconfig" ".config/Kvantum/MaterialAdw/MaterialAdw.svg" ".config/ags/assets/themes/sourceviewtheme.xml" ".config/ags/assets/themes/sourceviewtheme-light.xml")
...
if ! git pull; then
	...
	git clone --branch "$current_branch" https://github.com/l4v3nx/dots-hyprland/ --depth=1 "$temp_folder"
