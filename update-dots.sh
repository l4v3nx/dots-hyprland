...
excludes=(".config/ags/user_options.jsonc" ".config/fish/fish_variables" ".config/mpv/*" ".config/qt5ct/qt5ct.conf" ".config/qt6ct/qt6ct.conf" ".config/hypr/custom/general.conf")
